...
#define entinf_blank_term(s) ((struct entinf){SYMB_TERM, false, false, 0, {.term = {s, null}}, null})
#define entinf_blank_group(g) ((struct entinf){SYMB_GROUP, false, false, 0, {.group = {g, null, null}}, null})
#define entinf_blank_rule(r) ((struct entinf){RULE, false, false, 0, {.rule = {r}}, null})
